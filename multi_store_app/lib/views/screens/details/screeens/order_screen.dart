...
import 'package:multi_store_app/views/screens/details/widget/order_detail_screen.dart';
...
class _OrderScreenState extends ConsumerState<OrderScreen> {
  ...
  Future<void> _fetchOrders() async {
    ...
    if (user != null) {
      ...
      try {
        final orders = await orderController.fetchOrders(buyerId: user.id);
  ...
  Future<void> _deleteOrder(String orderId)async{
    ...
    try {
      ...
      _fetchOrders(); // refresh the screeen after deletion
    } catch (e) {
       debugPrint("Error deleting Orders");
    }
  }
