                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Column(
                                ...
                                children: [
                                  Text(cartItem.productName,style: GoogleFonts.lato(fontSize: 16,fontWeight: FontWeight.w600,),),
                                  Text(cartItem.category,style: GoogleFonts.lato(fontSize: 14,fontWeight: FontWeight.w600,color: Colors.grey),),
                                  Text("\$${cartItem.productPrice.toStringAsFixed(2)}",style: GoogleFonts.lato(fontSize: 16,fontWeight: FontWeight.bold,color: Colors.green),),
                                  Row(
                                    children: [
                                      Container(
                                        height: 40,
                                        ...
                                        child: Row(
                                          children: [
                                            ...
                                            Text(cartItem.quantity.toString(),style: const TextStyle(color: Colors.white),),
                                            IconButton(onPressed: (){
